 ...
 * @create 2020-03-08 18:34
 */
@Configuration
@ConditionalOnClass(HttpClient.class)
//加上这个就可以将HttpClientProperties作为一个bean引入进来
...
public class HttpClientAutoConfiguration {
    ...
    public HttpClient httpClient(){
        ...
        HttpClient client = HttpClientBuilder.create().setDefaultRequestConfig(requestConfig)//设置requestConfig
